          ...
          <div className="flex flex-wrap gap-2">
            {quickActions.map((action, index) => (
              <button
                ...
                className="text-sm bg-green-50 dark:bg-green-900/20 text-green-600 dark:text-green-400 px-4 py-2 rounded-full hover:bg-red-100 dark:hover:bg-green-900/30 transition-colors border border-green-200 dark:border-green-800"
              >
                {action.label}
              </button>
            ))}
