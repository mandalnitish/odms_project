  ...
  async function fetchUser() {
    ...
    try {
      ...
      if (userSnap.exists()) {
        ...
        // If donor has hospitalId → fetch hospital document
        if (data.hospitalId) {
          try {
                ...
                <div className="space-y-3">
                  {deduplicatedMatches.slice(0, 5).map((match, idx) => (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <p className="font-medium">Match with {match.recipientName}</p>
                  ...
                  {deduplicatedMatches.length === 0 && (
                    <p className="text-gray-500 text-center py-8">No matches yet. Your matches will appear here once found.</p>
                  )}
                </div>
              </div>
